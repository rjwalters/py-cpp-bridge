...
class PyArrayProcessor:
    """
    Python wrapper for C++ ArrayProcessor using ctypes.
    ...
    def process_preallocated(
        ...
        """
        Process array using a pre-allocated buffer.

        This method reuses the same results array for each call, making it
        efficient for repeated calls on arrays of the same size.
        ...
        Args:
            data: Input array of float32 values. Must be 1D with length matching size.
        ...
        Raises:
            ...
            ValueError: If array size doesn't match expected size
        """
        ...
    ...
    def process_new(
        ...
        """
        Process array by creating a new contiguous array.
    ...
    def process_manual(self, data: npt.NDArray) -> npt.NDArray[np.float32]:
        """
        Process array with manual copying and casting.
