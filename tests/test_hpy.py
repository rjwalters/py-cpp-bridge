...
# Import the compiled Python module (HPy version)
...
def main():
    ...
    # Test with list input (process_new should handle this)
    print("\n=== Testing with list input ===")
    data5 = [100, 200, 300, 400, 500]
    result5 = processor.process_new(data5)
    print(f"Input (list): {data5}")
    print(f"Output: {result5}")

    # Clean up
    processor.close()
    print("\n=== Processor closed successfully ===")
