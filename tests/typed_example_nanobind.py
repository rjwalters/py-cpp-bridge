"""Example of using nanobind_processor with type annotations."""
...
# Import the compiled Python module (nanobind version)
...
def process_batches(data_batches: List[npt.NDArray[np_values_type]], batch_size: int) -> List[npt.NDArray[np_values_type]]:
    ...
    Args:
        data_batches: List of float32 arrays to process
